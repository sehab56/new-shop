                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div class="product-tab">
                                            ...
                                            @foreach($catetoryProducts as $catetoryProduct)
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($catetoryProduct->product_image)}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="grid-img">
                                                                    <img  src="{{asset($catetoryProduct->product_image)}}" class="img-responsive"  alt="">
                                                                </div>
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="single.html">{{$catetoryProduct->product_name}}</a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p ><em class="item_price">TK.{{$catetoryProduct->product_price}}</em></p>
                                        ...
                                        <div class="product-tab1">
                                            ...
                                            <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                ...
                                                <div class="women">
                                                    <h6><a href="single.html">{{ $catetoryProduct->product_name }}</a></h6>
                                                    <span class="size">XL / XXL / S </span>
                                                    <p>{{ $catetoryProduct->short_description }} </p>
                                                    <p ><em class="item_price">Tk.{{ $catetoryProduct->product_price }}</em></p>
                                                    <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                </div>
                                            </div>
