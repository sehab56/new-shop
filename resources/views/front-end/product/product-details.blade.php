                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <form action="{{ route('add-to-card') }}" method="post">
                                    ...
                                    <div class="women">
                                        ...
                                        <input type="submit" name="btn" value="Add To Card" class="my-cart-b item_add"/>
                                    </div>
                                </form>
                    ...
                    <div class="col-md-3 single-grid1">
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive " src="{{ asset($product->product_image )}}" alt=""></a>
                            </div>
                            <div class="recent-right">
                                <h6 class="best2"><a href="single.html">{{ $product->short_description }} </a></h6>
                                <div class="block">
                                    <div class="starbox small ghosting"> </div>
                                </div>
